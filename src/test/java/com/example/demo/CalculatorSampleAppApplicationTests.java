...
public class CalculatorSampleAppApplicationTests {
 ...
 public void calcSub3() {
            Calculator c = new Calculator(15, 5, 1, "-"); //Arrange
            double result = c.calculateResult(); //Act
            assertEquals(9.0, result, 0.000001); //Assert
 }
 
  @Test
 public void calcMult3() {
            Calculator c = new Calculator(5, 5, 1, "*"); //Arrange
            double result = c.calculateResult(); //Act
            assertEquals(25.0, result, 0.000001); //Assert
  }
    @Test
